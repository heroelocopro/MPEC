...
use App\Livewire\Docente\DocenteActividades;
use App\Livewire\Docente\DocenteAnuncios;
use App\Livewire\Docente\DocenteAsistencias;
use App\Livewire\Docente\DocenteEvaluaciones;
use App\Livewire\Docente\DocenteForo;
use App\Livewire\Docente\DocenteGrupo;
use App\Livewire\Docente\DocenteHorarios;
use App\Livewire\Docente\DocenteInicio;
...
Route::middleware(['auth', 'role:docente'])->prefix('docente')->group(function () {
    Route::livewire('/inicio', DocenteInicio::class)->name('docente-inicio');
    Route::livewire('/grupo/{id}',DocenteGrupo::class)->name("docente-grupo");
    Route::livewire('/notas',DocenteNotas::class )->name('docente-notas');
    Route::livewire('/asistencias',DocenteAsistencias::class )->name('docente-asistencias');
    Route::livewire('/actividades',DocenteActividades::class )->name('docente-actividades');
    // Route::get('/tareas',[DocenteController::class,'mostrarNotas'] )->name('docente-tareas');
    Route::livewire('/evaluaciones',DocenteEvaluaciones::class)->name('docente-evaluaciones');
