...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Creacion de actividades para poner notas de ejemplo y crear un historial academico.

        // final del seeder no poner nada abajo
    }
}
