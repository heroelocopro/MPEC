                        ...
                        <div>
                            ...
                            @elseif (!empty($archivoGuardado))
                                ...
                                <p class="mt-1 text-sm text-blue-700 dark:text-blue-400">
                                    Archivo actual:
                                    {{ is_string($archivoGuardado) ? basename($archivoGuardado) : basename($archivoGuardado->archivo) }}
                                </p>

                                <a target="_blank"
                                href="{{ is_string($archivoGuardado)
                                            ? Storage::temporaryUrl($archivoGuardado, now()->addMinutes(30))
                                            : $archivoGuardado->archivo_url }}">
                                    descargar
                                </a>
